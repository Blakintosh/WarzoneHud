...
function Warzone.ScoreboardHeader.new(menu, controller)
    ...
    self.col0 = Util.TextElement(Util.Fonts.MainRegular, Util.Swatches.HUDMain, true)
    ...
    Util.AddShadowedElement(self, self.col0)

    self.col1 = Util.TextElement(Util.Fonts.MainRegular, Util.Swatches.HUDMain, true)
    ...
    Util.AddShadowedElement(self, self.col1)

    self.col2 = Util.TextElement(Util.Fonts.MainRegular, Util.Swatches.HUDMain, true)
    ...
    Util.AddShadowedElement(self, self.col2)

    self.col3 = Util.TextElement(Util.Fonts.MainRegular, Util.Swatches.HUDMain, true)
    ...
    Util.AddShadowedElement(self, self.col3)

    self.col4 = Util.TextElement(Util.Fonts.MainRegular, Util.Swatches.HUDMain, true)
    ...
    Util.AddShadowedElement(self, self.col4)

    self.ping = Util.TextElement(Util.Fonts.MainRegular, Util.Swatches.HUDMain, true)
    ...
    Util.AddShadowedElement(self, self.ping)
