...
Warzone.PreGameMenuHighResContainer = InheritFrom(LUI.UIElement)

function Warzone.PreGameMenuHighResContainer.new(menu, controller)
    ...
    self:setClass(Warzone.PreGameMenuHighResContainer)
    self.id = "PreGameMenuHighResContainer"
    self.soundSet = "iw8"
    ...
    self.hostInfo:setText("You are the host of this match.")
    ...
    self.buttonList:setDataSource("PreGameHost")
