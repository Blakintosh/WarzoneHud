...
function Warzone.OverclockMenuProgressMeter.new(menu, controller)
    ...
    Wzu.SetRGBFromTable(self.backer, Wzu.Colors.WarmerMedGrey)
    ...
    Wzu.SetRGBFromTable(self.upgradeMeter, Wzu.Colors.BlueGrey)
    ...
    Wzu.Subscribe(self.upgradeMeter, controller, "overclockTree.focusedUpgradeIndex", function(modelValue)
    ...
    Wzu.SetRGBFromTable(self.progress, Wzu.Colors.PictonBlue)
    ...
    Wzu.Subscribe(self.progress, controller, "currentWeapon.weaponOverclocks", function(modelValue)
